...
\title[Título corto]{Título largo del documento}
\subtitle{Subtítulo descriptivo del documento}
\author[Gabriel]{Gabriel Andrés Aguirre}
\date{\today}
\titlegraphic{\includegraphics[scale=0.225]{src/pdf/doc/logo.pdf}}
